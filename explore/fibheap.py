...
class FibonacciHeap:
    ...
    def dequeue_min(self):
        ...
        # for (Entry<T> curr = self.m_min;
        # toVisit.isEmpty() || toVisit.get(0) != curr; curr = curr.m_next)
        curr = self.m_min
        ...
        for curr in to_visit:
            ...
            while True:
                ...
                minimum = other if other.m_priority < curr.m_priority else curr
                maximum = curr if other.m_priority < curr.m_priority else other
    ...
    def cut_node(self, entry):
        ...
        if entry.m_parent.m_child is entry:
            ...
            entry.m_parent.m_child = None if entry.m_next is entry else entry.m_next
