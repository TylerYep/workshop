...
class KNearestNeighbors:
    ...
    def __init__(self, X: np.array, y: np.array, k: int = 2) -> None:
        """
    ...
    def compute_distances_naive(self, X: np.array) -> np.array:
        """
    ...
    def predict_labels(self, dists: np.array) -> np.array:
        """
